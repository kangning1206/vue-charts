<template>
  <div>
    <el-container>
      <el-header>
        <a href="https://d3js.org.cn" class="navbar-brand">
        <img src="https://d3js.org/logo.svg" alt="d3 logo"
      class="navbar-logo"></a>
  ...
  data() {
    return {
      menu: [
        ...
        // { title: '饼图', path: '/d3/pie', icon: 'el-icon-third-bingtu' },
        ...
        // { title: '雷达图', path: '/d3/radar', icon: 'el-icon-third-leidatu' },
        // { title: '漏斗图', path: '/d3/funnel', icon: 'el-icon-third-loudoutu' },
        // { title: '仪表盘', path: '/d3/gauge', icon: 'el-icon-third-yibiao' },
        // { title: '分布图', path: '/d3/dismap', icon: 'el-icon-third-yibiao' },
      ],
    };
  },
};
